...
export const ANIMALS: AnimalDef[] = [
  ...
  { id: "schwein", name: "Schwein", cost: 75, income: 4, intervalMs: 12000, boostFactor: 1.5, model: "/models/animals/Pig.glb", color: 0xff9aa2, size: 2.25 },
  { id: "schaf", name: "Schaf", cost: 150, income: 8, intervalMs: 50000, boostFactor: 1.25, model: "/models/animals/Sheep.glb", color: 0xeeeae0, size: 1.9 },
  { id: "kuh", name: "Kuh", cost: 200, income: 16, intervalMs: 80000, boostFactor: 1.15, model: "/models/animals/Cow.glb", color: 0x6b4f3a, size: 3.5 },
  { id: "pferd", name: "Pferd", cost: 500, income: 24, intervalMs: 120000, boostFactor: 1.05, model: "/models/animals/Horse.glb", color: 0x7a5230, size: 3.2 },
];
