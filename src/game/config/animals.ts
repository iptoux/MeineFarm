...
export const ANIMALS: AnimalDef[] = [
  ...
  { id: "schwein", name: "Schwein", cost: 75, income: 12, intervalMs: 6000, boostFactor: 2, model: "/models/animals/Pig.glb", color: 0xff9aa2, size: 1.25 },
  { id: "schaf", name: "Schaf", cost: 200, income: 32, intervalMs: 7000, boostFactor: 2, model: "/models/animals/Sheep.glb", color: 0xeeeae0, size: 1.5 },
  { id: "kuh", name: "Kuh", cost: 400, income: 60, intervalMs: 9000, boostFactor: 2, model: "/models/animals/Cow.glb", color: 0x6b4f3a, size: 1.95 },
  { id: "pferd", name: "Pferd", cost: 1500, income: 220, intervalMs: 12000, boostFactor: 2, model: "/models/animals/Horse.glb", color: 0x7a5230, size: 2.3 },
];
